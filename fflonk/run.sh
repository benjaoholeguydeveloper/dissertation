...
#setup fflonk
echo "setup fflonk"
snarkjs fflonk setup Multiplier3.r1cs pot12_final.ptau Multiplier3_final.zkey
...
# create proof fflonk
echo "create proof fflonk"
snarkjs fflonk prove Multiplier3_final.zkey witness.wtns proof.json public.json
