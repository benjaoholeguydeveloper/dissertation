...
echo "Compile Multiplier2 circuit";
circom Multiplier2.circom --r1cs --wasm --sym

echo "Multiplier2 circuit info"
...
#copy compiled file
cp input.json Multiplier2_js
cp input.json Multiplier2_cpp
cp Multiplier2.r1cs Multiplier2_js
cp Multiplier2.r1cs Multiplier2_cpp
...
#setup plonk
echo "setup plonk"
snarkjs plonk setup Multiplier2.r1cs pot12_final.ptau Multiplier2_final.zkey
